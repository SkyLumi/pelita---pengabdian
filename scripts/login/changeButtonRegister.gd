...
func _on_masuk_button_pressed():
    get_tree().change_scene_to_file("res://scenes/MainMenu/login_screen.tscn") # Ganti path ini!

func _on_daftar_button_pressed():
    get_tree().change_scene_to_file("res://scenes/MainMenu/register_screen.tscn") # Ganti path ini!

func _on_pengaturan_button_pressed():
    get_tree().change_scene_to_file("res://scenes/MainMenu/pengaturan_screen.tscn") # Ganti path ini!

func _on_petunjuk_button_pressed():
    get_tree().change_scene_to_file("res://scenes/MainMenu/petunjuk_screen.tscn")
